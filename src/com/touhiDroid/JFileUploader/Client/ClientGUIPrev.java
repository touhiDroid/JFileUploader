...
public class ClientGUIPrev extends JFrame {
	...
	public ClientGUIPrev(UploadListener upListener) {
		...
		buttonUpload.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				File[] fa = new File[2];
				fa[0]=f;
				uploadListener.startUpload(fa, fieldURL.getText(), portNumber);
			}
		});
